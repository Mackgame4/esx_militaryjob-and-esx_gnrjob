...
AddEventHandler('esx_militaryjob:drag', function(target)
  ...
  TriggerClientEvent('esx_militaryjob:drag', target, _source)
end)
...
AddEventHandler('esx_cmilitaryjob:OutVehicle', function(target)
...
ESX.RegisterServerCallback('esx_militaryjob:getFineList', function(source, cb, category)
  ...
  MySQL.Async.fetchAll(
    'SELECT * FROM fine_types_military WHERE category = @category',
    {
      ['@category'] = category
    },
    function(fines)
...
ESX.RegisterServerCallback('esx_militaryjob:addArmoryWeapon', function(source, cb, weaponName)
