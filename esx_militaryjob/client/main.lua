...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    {label = _U('military_wear'), value = 'military_wear'}
  }
  ...
  if Config.EnableNonFreemodePeds then
    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'military_wear' then
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    for i=1, #Config.militaryStations[station].AuthorizedVehicles, 1 do
      local vehicle = Config.militaryStations[station].AuthorizedVehicles[i]
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_militaryjob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_militaryjob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_militaryjob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_militaryjob:OutVehicle', GetPlayerServerId(player))
              end
...
AddEventHandler('esx_militaryjob:OutVehicle', function(t)
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'military' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'military' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'military_actions') and (GetGameTimer() - GUI.Time) > 150 then
...
RegisterNetEvent('NB:openMenumilitary')
AddEventHandler('NB:openMenumilitary', function()
	OpenmilitaryActionsMenu()
end)
